...
public class DuckWheel extends Subsystem {
    ...
    /**
     * Return the state of the duck wheel limit switch.
     *
     * @return The current state of the channel.
     * @see DigitalChannel#getState()
     */
    public boolean isPressed() {
        return duckWheelTouch.getState();
    }

    /**
     * Sets the current speed of the servo driving the duck wheel, expressed as a fraction of its
     ...
     * @see DuckWheel#getPower()
     */
    public void setPower(double power) {
        duckWheel.setPosition(power);
    }

    /**
     * Returns the speed at which the servo driving the duck wheel was last commanded to move.
     ...
     * @see DuckWheel#setPower(double)
     */
    public double getPower() {
        return duckWheel.getPosition();
    }
